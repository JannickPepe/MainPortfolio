        ...
        {isOpen && (
            ...
            >
                <motion.div
                    ...
                    className="top-[7rem] md:top-10 lg:top-8 xl:top-8 bg-gradient-to-br from-violet-600 to-indigo-600 text-white p-6 rounded-lg w-full max-w-lg shadow-xl cursor-default relative overflow-hidden"
                >
