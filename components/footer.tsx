...
export default function Footer() {
  ...
  return (
    ...
    <footer className="bg-gradient-to-r from-sky-200 to-gray-300 dark:bg-gradient-to-r dark:from-indigo-500 dark:to-slate-600">
      ...
      <div className="px-4 py-10 mx-auto sm:px-6 lg:px-16">
        <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
          <div>
            <div>
              ...
              <span className="text-slate-700 mx-2 font-bold text-2xl relative inline-block stroke-current dark:text-white">
                Jannick Pedersen
            ...
            <p className="max-w-md px-1 mt-4 text-sm text-gray-600 dark:text-slate-700 font-medium">
          ...
          <div className="grid grid-cols-1 gap-6 lg:col-span-2 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-3 lg:ml-6">
            <div className="">
              ...
              <div className="flex flex-col mt-4 space-y-2 text-gray-500 hover:cursor-pointer text-lg dark:text-slate-700 font-semibold">
                <a href="#home" className="hover:opacity-75 hover:text-sky-600 hover:dark:text-indigo-400">Home</a>
                <a href="#about" className="hover:opacity-75 hover:text-sky-600 hover:dark:text-indigo-400">About</a>
                <a href="#projects" className="hover:opacity-75 hover:text-sky-600 hover:dark:text-indigo-400">Projects</a>
                <a href="#skills" className="hover:opacity-75 hover:text-sky-600 hover:dark:text-indigo-400">Skills</a>
                <a href="#experience" className="hover:opacity-75 hover:text-sky-600 hover:dark:text-indigo-400">Experience</a>
                <a href="#reviews" className="hover:opacity-75 hover:text-sky-600 hover:dark:text-indigo-400">Reviews</a>
                <a href="#contact" className="hover:opacity-75 hover:text-sky-600 hover:dark:text-indigo-400">Contact</a>
              </div>
            </div>
            <div>
              <p className="font-medium dark:text-white text-2xl">
                Projects
              </p>
              <div className="flex flex-col mt-4 space-y-2 text-lg text-gray-500 dark:text-slate-700 font-semibold">
                <a href="https://nanoscale.up.railway.app/landing" className="hover:opacity-75 hover:text-sky-600 hover:dark:text-indigo-400">NanoScaleSimulations </a>
                <a href="https://next-js-13-e-shop.vercel.app/" className="hover:opacity-75 hover:text-sky-600 hover:dark:text-indigo-400">Orgone Jewels</a>
                <a href="https://jannick-hotel.vercel.app/" className="hover:opacity-75 hover:text-sky-600 hover:dark:text-indigo-400">Hotel Booking</a>
                <a href="https://tmsworld.vercel.app/" className="hover:opacity-75 hover:text-sky-600 hover:dark:text-indigo-400">Tell Me a Story</a>
                <a href="https://udemynextjsserverlessblog.vercel.app/" className="hover:opacity-7 hover:text-sky-6005 hover:dark:text-indigo-400">Serverless blog</a>
                <a href="https://jannickservice.netlify.app/" className="hover:opacity-75 hover:text-sky-600 hover:dark:text-indigo-400">SPA Service</a>
              </div>
            </div>
            <div>
              <p className="font-medium dark:text-white text-2xl">
        ...
        <p className="mt-2 text-xs text-gray-800 dark:text-slate-400">
          © 2023 Jannick Pedersen
        </p>
        <p className="text-xs mt-2 dark:text-slate-400">
